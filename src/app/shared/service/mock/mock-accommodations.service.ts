...
export const ACCOMMODATIONS: Accommodation[] = [
  ...
  },
  {
    ...
    commentaire_accommodation: 'Site fabuleux et maisonnette de rêve ! Gaëtan a été un hôte des plus sympathiques et attentionnés. Merci de nous avoir donné l\'occasion de passer de beaux moments dans la montagne ardéchoise !',
    id_user: 5,
    id_type: 1,
    id_address: 7,
  },
  {
    ...
    commentaire_accommodation: 'Super séjour dans cette petite maison retirée à Canicati. Antonio nous accueillis comme des rois et le dîner était magique !',
    id_user: 6,
    id_type: 5,
    id_address: 8,
  },
